...
cvar_t joy_ds_axispitch = {0, "joy_ds_axispitch", "4", "which joystick axis to query for looking up/down"};
cvar_t joy_ds_axisyaw = {0, "joy_ds_axisyaw", "3", "which joystick axis to query for looking right/left"};
