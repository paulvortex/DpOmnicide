...
"\n",
"// VorteX {\n",
"// #define SHOW_VERTEX_ALPHA\n",
"// #define SHOW_FOG\n",
"#ifdef USESUNLIGHT\n",
"#if defined(MODE_WATER) || (defined(MODE_LIGHTDIRECTION) && defined(USEDIFFUSE)) || defined(MODE_LIGHTDIRECTIONMAP_MODELSPACE) || defined(MODE_LIGHTDIRECTIONMAP_TANGENTSPACE) || defined(MODE_LIGHTDIRECTIONMAP_FORCED_LIGHTMAP) || defined(MODE_LIGHTDIRECTIONMAP_FORCED_VERTEXCOLOR) || defined(MODE_FAKELIGHT)\n",
"	#define USESUNDIRECTION\n",
"	#define SUNDIRECTION_DIFFUSEGAIN_BIAS  0.4\n",
"	#if defined(MODE_LIGHTDIRECTIONMAP_FORCED_VERTEXCOLOR) || defined(MODE_LIGHTDIRECTION)\n",
"		#define SUNDIRECTION_DIFFUSEGAIN_SCALE 3.0\n",
"	#else\n",
"		#define SUNDIRECTION_DIFFUSEGAIN_SCALE 9.0\n",
"	#endif\n",
"	#ifdef MODE_LIGHTDIRECTIONMAP_FORCED_VERTEXCOLOR\n",
"		#define SUNDIRECTION_COLOR_BASE     myhalf3(0.10, 0.10, 0.10)\n",
"	#else\n",
"		#define SUNDIRECTION_COLOR_BASE     myhalf3(0.25, 0.25, 0.25)\n",
"	#endif\n",
"	#define SUNDIRECTION_DIFFUSEGAIN_MAX 2.0\n",
"#endif\n",
"#endif\n",
"\n",
...
"	position.y += 2.0*sin(distanceSquared*sin(worldTime/143.0)/1000.0); // VorteX\n",
"	float y = position.y;\n",
"	float x = position.x;\n",
...
"	#endif\n",
"	return mix(fc, surfacecolor.rgb, dp_texture2D(Texture_FogMask, cast_myhalf2(length(EyeRelative)*fogfrac*FogRangeRecip, 0.0)).r);\n",
"#endif\n",
"}\n",
"#endif\n",
"#ifdef USEGAMMARAMPS\n",
...
"	myhalf  sunspecular = (pow(cast_myhalf(max(float(dot(reflect(SunlightVector, surfacenormal), eyenormal))*-1.0, 0.0)), SpecularPower) * 0.3 + sunenv*sunenv*sunenv*sunenv*sunenv * 70.0 * eyemod) * Color_Specular.x * WaterFlow.a;\n",
...
"	// distort\n",
"	vec4 screentx = SafeScreenTexCoord + vec2(surfacenormal).xyxy * DistortScaleRefractReflect * WaterFlow.a * (1.0 - sunspecular);\n",
"	// refract blur\n",
...
"	dp_FragColor.rgb = mix(refract * mix(vec3(1.0), RefractColor.rgb, WaterFlow.a), dp_texture2D(Texture_Reflection, screentx.zw).rgb * ReflectColor.rgb, fresnel * sqrt(WaterFlow.a)) + SUNSPECULARCOLOR;\n",
...
"\n",
"#ifdef USEFOG\n",
"	dp_FragColor.rgb = FogVertex(dp_FragColor);\n",
"#endif\n",
"#ifdef USEGAMMARAMPS\n",
"	dp_FragColor.r = dp_texture2D(Texture_GammaRamps, vec2(dp_FragColor.r, 0)).r;\n",
"	dp_FragColor.g = dp_texture2D(Texture_GammaRamps, vec2(dp_FragColor.g, 0)).g;\n",
...
"// VorteX {\n",
"#ifdef USEVERTEXTEXTUREBLEND\n",
"	vec3 OffsetVector = vec3(normalize(EyeVectorFogDepth.xyz).xy * ScaleSteps.x * vec2(-1, 1) * scale, -1);\n",
"#else\n",
...
"		// 0-0.4 : blending from alpha test to 0\n",
"		// 0.4-1.0 : blending from 1.0 to alpha test\n",
"		#define ALPHAGEN_SPLATMASK_BORDER 0.4\n",
"		color.a = mix(color.a, 1.0 * Alpha, max(0.0, (VertexColor.a - ALPHAGEN_SPLATMASK_BORDER) / (1.0 - ALPHAGEN_SPLATMASK_BORDER))) * min(1.0, VertexColor.a / ALPHAGEN_SPLATMASK_BORDER);\n",
"	#else\n",
...
"	diffusetex.r = mix(diffusetex.r, reflectcubesample.r, reflectmask.r);\n",
"	diffusetex.g = mix(diffusetex.r, reflectcubesample.g, reflectmask.g);\n",
"	diffusetex.b = mix(diffusetex.r, reflectcubesample.b, reflectmask.b);\n",
...
"	// VorteX {\n",
"	lightcolor *= 1.0 / max(0.15, lightnormal.z);\n",
"	// } VorteX\n",
...
"// VorteX {\n",
"#ifdef USESUNDIRECTION\n",
"#if defined(SUNDIRECTION_DIFFUSEGAIN_BIAS) && defined(SUNDIRECTION_DIFFUSEGAIN_SCALE)\n",
"	myhalf sundiffuse = min(SUNDIRECTION_DIFFUSEGAIN_MAX, max(0.0, SUNDIRECTION_DIFFUSEGAIN_BIAS + (dot(surfacenormal, SunlightVector) - SUNDIRECTION_DIFFUSEGAIN_BIAS)*SUNDIRECTION_DIFFUSEGAIN_SCALE - diffuse));\n",
"	diffusetex.rgb += diffusetex.rgb * sundiffuse * (SUNDIRECTION_COLOR_BASE + SunlightColor.rgb) * SunlightColor.a;\n",
"#endif\n",
"#endif\n",
"// } VorteX\n",
"#  ifdef USESPECULAR\n",
...
"	myhalf fade = ShadowMapCompare(ShadowMapTC);\n",
"	color.rgb *= fade;\n",
"	fade = 1.0 - fade;\n",
"	color.g *= 1.0 + fade*0.1;\n",
"	color.b *= 1.0 + fade*0.3;\n",
"	// } VorteX\n",
"#endif\n",
"\n",
"#ifdef USEDEFERREDLIGHTMAP\n",
